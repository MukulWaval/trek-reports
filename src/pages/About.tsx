...
const About: React.FC = () => {
  return (
    <div className="w-full h-full flex flex-col items-center pr-5 pl-5">
      <h1 className="sticky text-5xl mt-5 mb-10">About</h1>
      ...
      <div className="join join-vertical w-full">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
          ...
          <div className="collapse-content">
            <p>
              ...
              climbed challenging peaks, and walked trails that tell stories of
              nature's magnificence. Each trek has been a journey of growth,
              discovery, and inspiration. Through this platform, I aim to bring
              my adventures to life and inspire others to step into the
              wilderness with confidence. Whether you’re a seasoned trekker or
              someone just starting, I believe my experiences can guide you on
              your journey.
            </p>
          </div>
        </div>
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
          ...
          <div className="collapse-content">
            <p>
              ...
              knowledge I’ve gained along the way. From choosing the right gear
              to navigating unpredictable trails, trekking is a blend of
              preparation and spontaneity. This website is my way of giving back
              to the trekking community. Here, you’ll find:
            </p>
            <ul className="list-inside list-disc">
              <li>Detailed trek reports with itineraries and tips.</li>
              <li>Trail insights to help you plan your trips.</li>
              <li>Photos and stories that capture the magic of the trails.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
          ...
          <div className="collapse-content">
            <p>
              ...
              about the journey—the people I meet, the lessons I learn, and the
              memories I create. Here’s what I live by:
            </p>
            <ul className="list-inside list-disc">
              <li>
                <strong>Leave No Trace:</strong> Respecting nature is paramount.
                I always ensure my treks have minimal environmental impact.
              </li>
              <li>
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
          ...
          <div className="collapse-content">
            <p>
              ...
              passionate about trekking. I want this website to be a space where
              adventurers can:
            </p>
            <ul className="list-inside list-disc">
        ...
        <div className="collapse collapse-arrow join-item border-base-300 border">
          ...
          <div className="collapse-content">
            <p>
              I’d love for you to be part of this growing community! Here’s how
              you can connect:
            </p>
            <ul className="list-inside list-disc">
              <li>
